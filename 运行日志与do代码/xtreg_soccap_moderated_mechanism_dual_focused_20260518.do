...
local basename "xtreg_soccap_moderated_mechanism_dual_focused_20260518"
...
di "Task: focused dual-model mechanism test for debt moderation through social-capital leverage"
di "Model family 1: X*N -> M -> Y"
di "Model family 2: N -> M and X*M -> Y"
...
local yvars pat_apply_total pat_invent_apply pat_utility_apply ln_pat_apply_total ln_pat_utility_apply
local mvars ///
    soccap_leverage_w soccap_leverage_zero_w soccap_leverage_govp5_w ///
...
local samples all no2020 through2023 active_cum low_market low_fin
