...
#### 1. 安装python3.6.X工具[【压缩包】](https://data.csmar.com/static/python_3.6.0.rar)，并安装类库urllib3，websocket，websocket_client，pandas
...
#### 2.4 查看已购买数据表中所有的字段：getListFields(tableName)
...
![img](https://data.csmar.com/static/document/image-python001.png)